...
//import com.cg.domain.dto.order.OrderResponseDTO;
...
//    }
//
//    @GetMapping("/cashier/{tableId}")
//    public ResponseEntity<?> getTableWithOrderById(@PathVariable Long tableId) {
//
...
//            throw new DataInputException("Bàn chưa có hóa đơn");
//        }
//
//        orderResponseDTO.setOrderId(orderDTOList.get(0).getId());
//
//        orderResponseDTO.setTableId(tableId);
//
//        orderResponseDTO.setTotalAmount(orderDTOList.get(0).getTotalAmount());
//
//        orderResponseDTO.setStaffId(orderDTOList.get(0).getStaff().getId());
//
//        List<OrderItemResponseDTO> orderItems = orderItemService.getOrderItemResponseDTOByOrderId(orderDTOList.get(0).getId());
//
